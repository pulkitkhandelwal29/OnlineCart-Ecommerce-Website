...
class ProductGallery(models.Model):
    ...
    image = models.ImageField(upload_to='images/store/products/',max_length=255)
    ...
    class Meta:
        ...
        verbose_name_plural = 'product gallery' #making changes in admin page (display name of the model created in admin page)
